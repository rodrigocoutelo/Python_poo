...
class Loja(object):
  ...
  def locar(self, cliente:d.Cliente):
  ...
  def receber(self, cliente:d.Cliente) -> float:
    self._estoque += cliente.quantidade
  ...
  def calcula_valor_locacao(self, cliente:d.Cliente)->float:
  ...
  def calcula_tempo_locacao(self, cliente:d.Cliente):
    if self._fim == None:
